...
<body  style="background: repeating-radial-gradient(circle at 150%,white 20%, #181A72,#181A72); text-align : center;">
	...
	<h1 class="titre">Vendre une paire</h1>
	...
	<div class="gaucheform" style="text-align:center">
		<h1 style="color:white">Id de la paire à vendre : </h1>
		<?php
		$stock=obtenirStock();
		...
		?>
		<br>
		<h1 style="color:white">Prix de vente : </h1>
		<?php
		mkInput('number',"prix",'','placeholder="prix de vente" step="0.5"');
		?>
		<br>
		<h1 style="color:white">Date de vente : </h1>
		<?php
		mkInput('date',"date",'','placeholder="date de vente" step="0.01"');
		?>
		<br>
		...
		<br>
		<?php
		mkInput('submit','action','ajout_vente','class="boutonsubmit"');
		endForm();
		?>
	</div>
